...
demonstrates the banned form still misreports on the same input. The 23 existing
sites across 11 suites were converted in the same commit; a detector that cannot
go green is a detector nobody keeps.
...
committed suite, and 23 siblings of its exact shape were sitting in the repo the
...
23-site conversion). Prose for instances 1–4, with the narrowed reason stated
above.
...
- PR #308 / #307 — instance 6; the branch that produced the mechanism and the 23-site conversion
