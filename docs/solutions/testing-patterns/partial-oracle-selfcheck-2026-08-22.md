...
- **Sibling docs:**
  ...
  - `guard-and-subject-must-be-one-artifact-2026-08-25.md` — **the third recording**, and the case this entry's rule does not reach: coverage of the named artifact was *total* and still established nothing, because the deciding behavior sat in the caller's argument. Its Prevention rule (*choose oracle mutations adversarially against the guard's coverage*) was followed there and was not sufficient — the adversarial fixture was written against the right function in the wrong scope.
