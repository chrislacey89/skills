...
| Review someone else's PR | `/pre-merge --pr <n>` — reviewer-mode; same dimensions, output as draft comment text shaped by `references/comment-craft.md` |
