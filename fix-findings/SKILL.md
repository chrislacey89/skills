...
archived**, the mutation recorded as an edit (file, line, before, after — for
both the control and the mutant), and the command behind each. No conclusions
the human cannot re-run.
